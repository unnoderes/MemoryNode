...
This Vite application is the public landing page for MemoryNode. It presents the `0.8.0` local Python release and includes a browser-only simulator of the governed-memory lifecycle.
