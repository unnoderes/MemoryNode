...
const capabilities = [
  ...
  { label: '06', name: '本地 MCP + CLI 分发', desc: '0.7.0 Python 包含 SDK、CLI、stdio MCP、受 bearer token 保护的本地 HTTP MCP、后端和治理控制台。', tech: 'Local tools' },
];
...
export default function Capabilities() {
  return <section className="caps-section" id="capabilities"><div className="container">
    ...
    <p className="caps-subtitle animate-fade-in">MemoryNode 0.7.0 专注于一个可验证的本地闭环：让记忆先被治理，再被使用。</p>
