  ...
  return (
    <section>
      ...
      <div className="paradigm-comparison-grid">
        ...
        <div className="p-8 rounded border border-white/5 bg-neutral-950 text-left vector-db-card">
          <h3 className="text-base font-bold text-neutral-400 mb-4">{t("✕ 传统盲目记忆 (Vector DB Auto-commit)", "Traditional Vector DB Auto-commit")}</h3>
          <ul className="space-y-4 text-xs sm:text-sm text-slate-500 leading-relaxed">
        ...
        {/* Governed Memory */}
        <div className="p-8 rounded border border-white/20 bg-neutral-900 text-left governed-mem-card">
          <h3 className="text-base font-bold text-white mb-4">{t("✓ MemoryNode 受管记忆 (Governed Memory)", "MemoryNode Governed Memory")}</h3>
